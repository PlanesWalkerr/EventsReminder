package com.makhovyk.eventsreminder.database;
...
public class SQLiteDBHelper extends SQLiteOpenHelper {
    ...
    private static final String EVENT_PERSON_NAME = "personName";
    private static final String EVENT_PERSON_PHONE = "phone";
    private static final String EVENT_IS_YEAR_KNOWN = "isYearUnknown";
    private static final String EVENT_TIMESTAMP = "time_stamp";
