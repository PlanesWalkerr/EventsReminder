package com.makhovyk.eventsreminder.adapters;
...
import com.makhovyk.eventsreminder.activities.EditEventActivity;
...
public class ListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    class OtherEventHolder extends RecyclerView.ViewHolder {
    ...
    public ListAdapter(ArrayList<Item> events, Context context) {
        this.events = events;
    ...
    private void deleteEvent(Event event) {
        ...
        events.remove(event);
        new AlarmHelper(context).deleteAlarms(event.getTimestamp());
